...
def main():
    ...
    if fetch_button or (hasattr(st.session_state, 'fetch_config') and st.session_state.get('data_fetched', False)):
        ...
        with tabs[6]:
            ...
            st.plotly_chart(create_net_gex_flow_chart(df_latest, spot_price), use_container_width=True)
        ...
        with tabs[7]:
            ...
            st.plotly_chart(create_net_dex_flow_chart(df_latest, spot_price), use_container_width=True)
